...
public class ThinginfoFrontController extends BaseFrontController {
    ...
    // 显示全部数据//单价过的
    @RequestMapping("thinginfo.do")
    public String thinginfo(HttpServletRequest request, Map<String, Object> map) {
        this.front();
        Map<String, Object> parameter = new HashMap<String, Object>();
        String thinginfokeyword = request.getParameter("thinginfokeyword");//搜索关键词
        if (thinginfokeyword != null && thinginfokeyword != "") parameter.put("keyword", thinginfokeyword);//搜索参数
        ...
        map.put("thinginfokeyword", thinginfokeyword);
        map.put("pager", pager);



        map.put("thinginfoList", thinginfoList);
        return "thinginfo";//跳转到webApp目录下对应的JSP页面
    }


    // 按主键查询数据
    @RequestMapping("thinginfoDetail.do")
    public String thinginfoDetail(String id, Map<String, Object> map) {
        this.front();
        Map<String, Object> parameter = new HashMap<String, Object>();
        ...
        return "thinginfoDetail";//跳转到webApp目录下对应的JSP页面
    }
