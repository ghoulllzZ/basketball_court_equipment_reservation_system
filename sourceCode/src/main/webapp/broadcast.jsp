        ...
        <div class="layui-col-md12">
            <form class="search_list layui-form " action="" method="post">
                <div class="layui-form-item">
                    <div class="layui-input-inline">
                        <input type="text" name="broadcastkeyword" id="broadcastkeyword" lay-verify="required"
            ...
            <ul class="pic_ul_css ">
                        <c:forEach items="${broadcastList}" var="broadcast">
                            ...
                            <li>
                                <a href="front/broadcastDetail.do?id=${broadcast.broadcastid }">
                                    <img src="${broadcast.image }"/>
                                </a>
                                <p class="name">

                                    <a href="front/broadcast.do?broadcast_kindsid=${broadcast.broadcast_kindsid }">
                                        [${broadcast.broadcast_kindsname }]


                                    </a>
                                    <a href="front/broadcastDetail.do?id=${broadcast.broadcastid }">${broadcast.title }
                    ...
                    <TD>
                        <form class="list_page" action="" method="get" name="formpage">
                            ...
                            <input type="hidden" name="jumpurl"
                                   value="front/broadcast.do?<c:if test="${broadcast_kindsid!=null}">broadcast_kindsid=${broadcast_kindsid}&</c:if>"/>
                            <!--//用于给上面javascript传值-->
