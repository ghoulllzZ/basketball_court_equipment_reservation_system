...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-row   layout_page">
        ...
        <div class="layui-col-md12">
            ...
            <ul class="pic_ul_css ">
                        <c:forEach items="${classifyinfoList}" var="classifyinfo" varStatus="status">
                            <li>
                                <a href="front/classifyinfoDetail.do?id=${classifyinfo.classifyinfoid }">
                                    <img src="${classifyinfo.image }" class="project-img"/>
                                </a>
                                ...
                                <p class="name">
                                    ...
                                    <a
                                            href="front/classifyinfoDetail.do?id=${classifyinfo.classifyinfoid }"
                                    > ${classifyinfo.title } </a>
