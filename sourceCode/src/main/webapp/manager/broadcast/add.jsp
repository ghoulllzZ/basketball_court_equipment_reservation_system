...
<div class="layui-row">
    ...
    <form class="layui-form layui_form_web" method="post" action="manager/broadcast/add.do"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block"  >
                ...
                <select name="broadcast_kindsid"
                        style="width: 160px;z-index: 999999" id="broadcast_kindsid">
