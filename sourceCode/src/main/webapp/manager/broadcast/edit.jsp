...
<head>
    ...
    <script type="text/javascript">
        ...
        function selvideopath() {
            layer.open({
                type: 2,
                title: '上传视频',
                area: ['500px', '100px'],
                offset: '250px',
                content: '<%=basePath%>upload_files.jsp'
            });
        }
...
<div class="layui-row">
    ...
    <form class="layui-form layui_form_web" method="post" action="manager/broadcast/update.do" name="myform"
          onsubmit="return check()">
        <input
                type="hidden" name="broadcastid" value="${broadcast.broadcastid}"/>
        <input type="hidden" name="membersid" value="0">
        <div class="layui-form-item">
            ...
            <div class="layui-input-block"><input type="text" lay-verify="required" required="required"
                                                  ...
                                                  style="width: 160px" id="title" value="${broadcast.title}"/></div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                ...
                <select name="broadcast_kindsid" style="width: 160px;z-index: 999999;overflow: visible;"
                        id="broadcast_kindsid">
                    <option value="${broadcast.broadcast_kindsid}">${broadcast.broadcast_kindsname }</option>

                    <c:forEach items="${broadcast_kindsList}" var="broadcast_kinds">
                        <option value="${broadcast_kinds.broadcast_kindsid}">${broadcast_kinds.broadcast_kindsname }</option>
                    </c:forEach>
                </select>
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" lay-verify="required" required="required" class="layui-input" name="image"
                       style="width: 160px" id="image" value="${broadcast.image}"
                       onclick="selimage();" readonly="readonly"/></div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">视频</label>
            <div class="layui-input-block"><input type="text" lay-verify="required" required="required"
                                                  class="layui-input" placeholder="请选择视频"
                                                  name="videopath" style="width: 160px" id="videopath"
                                                  value="${broadcast.videopath}"
                                                  onclick="selvideopath();" readonly="readonly"/></div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="radio" name="istop"
                       ...
                       <c:if test="${broadcast.istop=='是'}">checked="checked"</c:if>
                       title="是"/>
                <input
                        <c:if test="${broadcast.istop=='否'}">checked="checked"</c:if>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="radio" name="isflv"
                       id="isflv" value="是"
                       <c:if test="${broadcast.isflv=='是'}">checked="checked"</c:if>
                       title="是"/>
                <input
                        <c:if test="${broadcast.isflv=='否'}">checked="checked"</c:if>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <script id="contents" name="contents" type="text/plain">${broadcast.contents}</script>
        ...
        <div class="layui-form-item">
            <div class="layui-input-block">
                <input type="hidden" name="addtime" id="addtime"
                       value="<fmt:formatDate value="${broadcast.addtime}" pattern="YYYY-MM-dd"/>"/>
                <input type="hidden" name="hits" id="hits" value="${broadcast.hits}"/>
...
<script>
    function check() {
        ...
        if (document.myform.broadcast_kindsid.value == '') {
            alert('请输入分类');
            return false;
        }
