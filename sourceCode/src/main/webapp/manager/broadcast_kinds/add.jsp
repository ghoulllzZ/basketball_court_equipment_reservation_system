...
<div class="layui-row">
    ...
    <form class="layui-form layui_form_web" method="post" action="manager/broadcast_kinds/add.do"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block"><input type="text" lay-verify="required" required="required"
                                                  ...
                                                  name="broadcast_kindsname" style="width: 160px"
                                                  id="broadcast_kindsname"/></div>
        </div>
        <div class="layui-form-item">
