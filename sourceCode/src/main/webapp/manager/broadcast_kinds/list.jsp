...
<table lay-filter="tabledata">
    <thead>
    <tr>
        <th lay-data="{escape:false,align:'center',field:'a' }">分类名称</th>
        <th lay-data="{escape:false,align:'center',field:'b' }">操作</th>
    </tr>
    </thead>
    <tbody>
    <c:forEach items="${broadcast_kindsList}" var="broadcast_kinds">
        <tr>
            <td align="center">${broadcast_kinds.broadcast_kindsname}</td>
            <td align="center">
                <a
                        href="manager/broadcast_kinds/getById.do?id=${broadcast_kinds.broadcast_kindsid}"
                          class="layui-btn layui-btn-xs" >编辑</a>
                <a
                        href="manager/broadcast_kinds/delete.do?id=${broadcast_kinds.broadcast_kindsid}"
    ...
    <TR align="right">
        <TD>
            <form class="list_page" action="" method="get" name="formpage">
                ...
                <!--//用于给上面javascript传值-->
                <input type="hidden" name="jumpurl" value="manager/broadcast_kinds/getAll.do?"/>
                <!--//用于给上面javascript传值-->
