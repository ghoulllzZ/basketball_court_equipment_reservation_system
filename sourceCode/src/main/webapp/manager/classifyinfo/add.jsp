...
<div class="layui-row">
    ...
    <form class="layui-form layui_form_web" method="post" action="manager/classifyinfo/add.do"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block"><input type="text" lay-verify="required" required="required"
                                                  class="layui-input" placeholder="请输入场地器材类型名称"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block"><input type="text" lay-verify="required" required="required"
                                                  ...
                                                  name="contact" style="width: 160px" id="contact"/></div>
        </div>
        <div class="layui-form-item">
