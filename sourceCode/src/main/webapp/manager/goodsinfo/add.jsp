...
<div class="layui-row">
    ...
    <form class="layui-form layui_form_web" method="post" action="manager/goodsinfo/add.do"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block"><input type="text" lay-verify="required" required="required"
                                                  class="layui-input" placeholder="请输入商品名称"
                                                  name="goodsinfoname" style="width: 160px" id="goodsinfoname"/>
            </div>
        </div>
