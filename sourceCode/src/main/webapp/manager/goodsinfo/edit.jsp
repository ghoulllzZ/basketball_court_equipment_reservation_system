...
<div class="layui-row">
    ...
    <form class="layui-form layui_form_web" method="post" action="manager/goodsinfo/update.do"
          name="myform" onsubmit="return check()">
        <input type="hidden" name="goodsinfoid" value="${goodsinfo.goodsinfoid}"/>
        <input type="hidden" name="iscooled" value="${goodsinfo.iscooled}"/>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" lay-verify="required" required="required"
                       class="layui-input" name="goodsinfoname"
                       style="width: 160px" id="goodsinfoname" value="${goodsinfo.goodsinfoname}"/>
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" lay-verify="required" required="required" class="layui-input"
                       value="${goodsinfo.image}"
                       name="image" style="width: 160px" id="image"
                       onclick="selimage();" readonly="readonly"/>
            </div>
        </div>
        <input type="hidden"
               name="createdate" id="createdate" value="${goodsinfo.createdate}"/>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                ...
                <script id="remark" name="remark" type="text/plain"> ${goodsinfo.remark} </script>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="number" lay-verify="required" required="required"
                       class="layui-input" placeholder="请输入库存数量"
                       name="countrequire" style="width: 160px" id="countrequire" value="${goodsinfo.countrequire}"/>
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="number" lay-verify="required" required="required"
                       ...
                       name="goodsinfoprice" style="width: 160px" id="goodsinfoprice"
                       value="${goodsinfo.goodsinfoprice}"/>
            </div>
        </div>
