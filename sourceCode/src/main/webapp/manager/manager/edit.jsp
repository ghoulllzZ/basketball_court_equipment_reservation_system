...
<div class="layui-row">
    ...
    <form class="layui-form layui_form_web" method="post" action="manager/manager/update.do"
          name="myform" onsubmit="return check()">
        <input
                type="hidden" name="managerid" value="${manager.managerid}"/>
        <input
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block"><input type="text" lay-verify="required" required="required"
                                                  ...
                                                  style="width: 160px" id="username" value="${manager.username}"/></div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block"><input type="text" lay-verify="required" required="required"
                                                  ...
                                                  style="width: 160px" id="realname" value="${manager.realname}"/></div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">联系方式</label>
            <div class="layui-input-block"><input type="text" lay-verify="required" required="required"
                                                  class="layui-input" name="contact"
                                                  style="width: 160px" id="contact" value="${manager.contact}"/></div>
        </div>
        <div class="layui-form-item">
