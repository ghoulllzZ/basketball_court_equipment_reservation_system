...
<div class="layui-row">
    ...
    <form class="layui-form layui_form_web" method="post" action="manager/thinginfo/update.do"
          name="myform" onsubmit="return check()">
        <input type="hidden" name="thinginfoid" value="${thinginfo.thinginfoid}"/>
        <input type="hidden" name="status" value="${thinginfo.status}"/>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                ...
                <select name="classifyinfoid"
                        style="width: 160px;z-index: 999999" id="classifyinfoid">
                    <option value="${thinginfo.classifyinfoid}">${thinginfo.classifyinfotitle }</option>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" lay-verify="required" required="required"
                       class="layui-input" name="thinginfoname"
                       style="width: 160px" id="thinginfoname" value="${thinginfo.thinginfoname}"/>
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" lay-verify="required" required="required" class="layui-input"
                       value="${thinginfo.image}"
                       name="image" style="width: 160px" id="image"
                       onclick="selimage();" readonly="readonly"/>
            </div>
        </div>
        <input type="hidden"
               name="createdate" id="createdate" value="${thinginfo.createdate}"/>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                ...
                <script id="remark" name="remark" type="text/plain"> ${thinginfo.remark} </script>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="number" lay-verify="required" required="required"
                       ...
                       name="countrequire" style="width: 160px" id="countrequire" value="${thinginfo.countrequire}"/>
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="number" lay-verify="required" required="required"
                       ...
                       name="thingprice" style="width: 160px" id="thingprice" value="${thinginfo.thingprice}"/>
            </div>
        </div>
        <div class="layui-form-item">
            <div class="layui-input-block">
